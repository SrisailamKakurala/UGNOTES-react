...
const Navbar = () => {
  ...
  return (
    <div className="relative z-50 shadow-xl px-5 md:px-12 lg:px-20 py-3 flex justify-between items-center">
      <Link to={'/home'}>
      ...
      <Link to={'/profile'}>
        <img onClick={() => { setHome(false); setAddnotes(false) }} className='profile cursor-pointer rounded-full h-12' src={defaultProfile} alt="" />
      </Link>
    </div>
  )
}
